---
permalink: /provider-opentofu/0.2/opentofu/v1beta1/providerConfig/
---

# opentofu.v1beta1.providerConfig
...
* [`obj spec`](#obj-spec)
  * [`fn withBackendFile(backendFile)`](#fn-specwithbackendfile)
  * [`fn withConfiguration(configuration)`](#fn-specwithconfiguration)
  * [`fn withCredentials(credentials)`](#fn-specwithcredentials)
  * [`fn withCredentialsMixin(credentials)`](#fn-specwithcredentialsmixin)
  * [`fn withPluginCache(pluginCache)`](#fn-specwithplugincache)
  * [`obj spec.credentials`](#obj-speccredentials)
    * [`fn withFilename(filename)`](#fn-speccredentialswithfilename)
...
### fn spec.withBackendFile

```ts
withBackendFile(backendFile)
```
...
### fn spec.withPluginCache

```ts
withPluginCache(pluginCache)
```
...
### fn spec.credentials.withFilename
